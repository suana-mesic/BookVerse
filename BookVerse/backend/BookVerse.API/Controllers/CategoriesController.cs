...
using BookVerse.Application.Modules.Catalog.Categories.Commands.Delete;
using BookVerse.Application.Modules.Catalog.Categories.Commands.Status.Disable;
using BookVerse.Application.Modules.Catalog.Categories.Commands.Status.Enable;
...
public class CategoriesController(ISender sender) : ControllerBase
{
    ...
    {
        await sender.Send(new DisableCategoryCommand { Id = id }, ct);
        return NoContent();
    }
    ...
    {
        await sender.Send(new EnableCategoryCommand { Id = id }, ct);
        return NoContent();
    }
}
