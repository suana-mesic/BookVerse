...
/// </summary>
public sealed class BookVerseBusinessRuleException : Exception
{
    public string Code { get; }

    public BookVerseBusinessRuleException(string code, string message)
        : base(message)
    {
        Code = code;
    }

    public BookVerseBusinessRuleException(string code, string message, Exception? innerException)
