...
public partial class StaticDataSeeder
{
    ...
    private static void SeedMoreUsers(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MarketUserEntity>().HasData(new List<MarketUserEntity>
        {
            new MarketUserEntity { Id = 5, FirstName = "Amer", LastName = "Hadžić", Email = "amer.hadzic@gmail.com", PasswordHash = hasher.HashPassword(null!, "string"), IsAdmin = false, IsManager = false, IsEmployee = false, IsEnabled = true, IsDeleted = false, AddressId = 4, TwoFactorEnabled = false, CreatedAtUtc = DateTime.UtcNow },
            new MarketUserEntity { Id = 6, FirstName = "Lejla", LastName = "Begović", Email = "lejla.begovic@gmail.com", PasswordHash = hasher.HashPassword(null!, "string"), IsAdmin = false, IsManager = false, IsEmployee = false, IsEnabled = true, IsDeleted = false, AddressId = 5, TwoFactorEnabled = false, CreatedAtUtc = DateTime.UtcNow },
            new MarketUserEntity { Id = 7, FirstName = "Mirza", LastName = "Kovačević", Email = "mirza.kovacevic@gmail.com", PasswordHash = hasher.HashPassword(null!, "string"), IsAdmin = false, IsManager = false, IsEmployee = false, IsEnabled = true, IsDeleted = false, AddressId = 6, TwoFactorEnabled = false, CreatedAtUtc = DateTime.UtcNow },
            new MarketUserEntity { Id = 8, FirstName = "Amira", LastName = "Šehić", Email = "amira.sehic@gmail.com", PasswordHash = hasher.HashPassword(null!, "string"), IsAdmin = false, IsManager = false, IsEmployee = false, IsEnabled = true, IsDeleted = false, AddressId = 7, TwoFactorEnabled = false, CreatedAtUtc = DateTime.UtcNow },
            new MarketUserEntity { Id = 9, FirstName = "Damir", LastName = "Muratović", Email = "damir.muratovic@gmail.com", PasswordHash = hasher.HashPassword(null!, "string"), IsAdmin = false, IsManager = false, IsEmployee = false, IsEnabled = true, IsDeleted = false, AddressId = 8, TwoFactorEnabled = false, CreatedAtUtc = DateTime.UtcNow },
        });
    }
